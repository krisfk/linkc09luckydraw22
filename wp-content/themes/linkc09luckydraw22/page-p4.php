...
?>
    ...
    <div class="text-center page4-content-outer">
        <div class="text-center page4-content">
            ...
            <img style="height:70px;" src="https://linkc09luckydraw22.com/wp-content/uploads/2022/07/img_p5_img.png"
                alt="">
   ...
   top: -7px;
    ...
    z-index: 100;">密碼不正確</div>
            ...
            <div class="text-center orange mt-4" style="font-size:1.5rem">
                ...
                <span style="font-size:1.6rem;font-weight:bold;">你已自動晉級「終極大抽獎」！</span><br>
